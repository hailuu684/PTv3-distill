...
"""
# extract files: tar -xvf file1.tar -C /destination/path/;
# tar -xvjf nuScenes-lidarseg-all-v1.0.tar.bz2 -C /desired/destination/

# replace your email and password in https://www.nuscenes.org/
useremail = "luutunghai@gmail.com"
password = "Hai@1234!"

output_dir = "/data/user/luutunghai@gmail.com/dataset/sets/nuscenes"
...
def download_processed_infor_nuscenes():
    from datasets import load_dataset

    ds = load_dataset("Pointcept/nuscenes-compressed")
