...
enable_amp = True
batch_size_test = 1
teacher_ckpt_path = "/users/PCS0253/dingz/projects/ptv3_distill/PTv3-distill/exp/dataset_type/waymo/waymo-train-teacher_4_2/model/model_best.pth"
gamma_param = 0.3
beta_param = 0.3
labmda_param = 10.0
...
model = dict(
    ...
    kld_distill = [dict(type='KLDistillLoss', loss_weight=gamma_param)],
    chamfer_distill = [dict(type='TDAChamferLoss', loss_weight=beta_param)],
    gkd_distill = [dict(type='GKDFeatureLoss', loss_weight=labmda_param)],
